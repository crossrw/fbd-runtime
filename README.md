...
Программируемый логический контроллер (ПЛК или PLC) это устройство, используемое для автоматизации технологических процессов. В качестве основного режима работы ПЛК выступает его длительное автономное использование без вмешательства (или с ограниченным вмешательством) человека.
...
* Подключение к информационной сети (network), объединяющией несколько ПЛК и обеспечивающей их совместное функционирование
* Содержит средства реализации интрфейса с человеком (HMI) с помощью индикатора, дисплея, клавиатуры и т.п.
