...
* [**Описания элементов**](#a5)
  ...
  + [Битовые операции](#a5.41)
    - [Побитное логическое "И"](#a5.41.1)
    - [Побитное логическое "ИЛИ"](#a5.41.2)
    - [Побитное логическое "Исключающее ИЛИ"](#a5.41.3)
...
* T - период формируемоый последовательности (мс)
* Q - выход

Если на входе T присутствует значение сигнала меньшее или равное "0", то генератор остановлен и на его выходе Q формируется сигнал со значенем "0". При положительном значении сигнала на входе T генератор формирует на выходе Q периодический сигнал с амплитудой A и периодом T. Значение сигнала на выходе Q всегда лежит в диапазоне от "0" до "A". В зависимости от настройки элемента, выполненной при проектировании схемы, форма сигнала может быть следующих видов:
