...
* [**Описания элементов**](#a5)
  ...
  + [Функции регулирования](#a5.5)
    - [Пропорциональное регулирование](#a5.5.1)
...
Элемент имеет два входа и один выход. Значение выходного сигнала вычисляется, как арифметическое деление значения сигнала на первом входе (делимое) на значение сигнала навтором входе (делитель).
